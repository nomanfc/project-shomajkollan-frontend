          ...
          >
            ...
            <s.OrgDetailsHeaderMenu style={{ margin: "auto", width: "100%" }}>
              <s.wrapper style={{background: ""}}>
                <s.SubDivBodyHeader style={{color: "#6F4283",}}  >কার্য এলাকা :</s.SubDivBodyHeader>
                <s.SubDivBodyText >{formData?.workArea || "-----"}</s.SubDivBodyText>
              </s.wrapper>
              <s.wrapper style={{background: "#EFF8F3"}}>
                <s.SubDivBodyHeader style={{color: "#6F4283",}}>
              ...
              <s.wrapper style={{background: ""}}>
                <s.SubDivBodyHeader style={{color: "#6F4283",}} >রেজিস্ট্রিকরণের তারিখ :</s.SubDivBodyHeader>
                <s.SubDivBodyText >{formData?.regDate || "-----"}</s.SubDivBodyText>
              </s.wrapper>
              <s.wrapper style={{background: "#EFF8F3"}}>
                <s.SubDivBodyHeader style={{color: "#6F4283",}}>স্থাপনের তারিখ :</s.SubDivBodyHeader>
              ...
              <s.wrapper style={{background: ""}}>
                <s.SubDivBodyHeader style={{color: "#6F4283",}} > সংস্থার ইমেইল : </s.SubDivBodyHeader>
                <s.SubDivBodyText >{formData?.orgEmail || "-----"}</s.SubDivBodyText>
              </s.wrapper>
              <s.wrapper style={{background: "#EFF8F3"}}>
                <s.SubDivBodyHeader style={{color: "#6F4283",}}>সংস্থার ওয়েবসাইট :</s.SubDivBodyHeader>
              ...
              <s.wrapper style={{background: "#EFF8F3"}}>
                <s.SubDivBodyHeader style={{color: "#6F4283",}}>মন্তব্য :</s.SubDivBodyHeader>
