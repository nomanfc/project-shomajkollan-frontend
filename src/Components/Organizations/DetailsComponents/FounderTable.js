...
import { deleteFounder } from "../../../Auth/httprequests.js";
...
import { ColumnDataFounder } from "./ColumnData";
...
const FounderTable = (props) => {
  ...
  const deleteHandler = (data) => () => {
    deleteFounder(data.id).then((res) => {
  ...
  const headerColumn = useMemo(() => ColumnDataFounder, []);
  ...
  return (
    <s.BasicTableContainer style={{fontFamily: 'Kalpurush'}}>
      ...
      <s.showSize >
        ...
        >
          {[10, 50, 100, 500].map((pageSize, index) => (
