  ...
  return (
    ...
    >
      <form onSubmit={handleSearch}>
        <InputBase
          sx={{ ml: 1, flex: 1 }}
          placeholder="সংস্থার নাম অথবা রেজিস্ট্রি নম্বর"
          ...
          autoComplete="off"
          style={{ width: "100%", fontSize: "15px",height: '30px',padding: '5px' , fontFamily: "kalpurush" }}
        />
      </form>
      ...
      <IconButton sx={{ p: "5px" }} aria-label="search" onClick={handleSearch}>
        <SearchIcon />
      </IconButton>
    </Paper>
  );
