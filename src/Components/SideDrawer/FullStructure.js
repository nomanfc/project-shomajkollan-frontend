    ...
    <div style={{ fontFamily: "Kalpurush" }}>
      ...
      <Drawer variant="permanent" open={open} style={{ fontSize: "10px" }}>
        ...
        {SideLinksDash.map((menuItems, index) => (
          ...
          >
            {activeIcon === index ? (
              ...
              // ""
              <ListItemIcon
                style={{ fontSize: "25px", fontFamily: "Kalpurush" }}
              >
                {menuItems.icon}
              </ListItemIcon>
            )}
        ...
        <ListItem>
          ...
          <ListItemText
            style={{ color: "gray", textShadow: "0 1px 1px black" }}
          >
            সংস্থা
          </ListItemText>
        </ListItem>
        ...
        <ListItem
          style={{
            display: profile.data.type === "unit officer" ? "none" : "flex",
          }}
        >
          <ListItemIcon style={{ fontSize: "25px", color: "#099F19" }}>
            <PeopleSharpIcon />
