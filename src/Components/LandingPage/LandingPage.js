        ...
        <s.div_three>
          {searchKeyword.length > 0
            ? filteredResults?.map((d, index) => (
                <s.ContentBodyContainer key={index}>
                  <div
                    style={{ fontSize: "20px", color: "white", margin: "auto" }}
                  >
                    {d.orgName}
                  </div>
                  <div
                    style={{ fontSize: "15px", color: "black", margin: "auto" }}
                  >
                    {d.orgVillage + ", " + d.orgPost}
                  </div>
                  <div
                    style={{ fontSize: "15px", color: "black", margin: "auto" }}
                  >
